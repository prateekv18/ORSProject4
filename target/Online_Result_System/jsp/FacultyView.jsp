<%@page import="com.rays.ors.bean.SubjectBean"%>
<%@page import="com.rays.ors.bean.CollegeBean"%>
<%@page import="com.rays.ors.bean.CourseBean"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.ors.util.HTMLUtility"%>
<%@page import="java.util.HashMap"%>
<%@page import="com.rays.ors.controller.FacultyCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.ors.bean.FacultyBean"
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="firstname"
						...
						value="<%=DataUtility.getStringData(bean.getFname())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="lastname"
						...
						value="<%=DataUtility.getStringData(bean.getLname())%>"></td>

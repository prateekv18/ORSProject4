<%@page import="com.rays.ors.model.StudentModel"%>
<%@page import="com.rays.ors.util.ServletUtility"%>
<%@page import="com.rays.ors.util.HTMLUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.ors.bean.StudentBean"%>
<%@page import="com.rays.ors.controller.StudentListCtl"%>
...
<body>
<jsp:useBean id="cbean" class="com.rays.ors.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="com.rays.ors.bean.StudentBean" scope="request" ></jsp:useBean>

...
<%@page import="com.rays.ors.controller.CourseListCtl"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.ors.bean.CourseBean"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.ors.controller.CourseCtl"%>
...
<body>
<jsp:useBean id="bean" class="com.rays.ors.bean.CourseBean" scope="request" ></jsp:useBean>

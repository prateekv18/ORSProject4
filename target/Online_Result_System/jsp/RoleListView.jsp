<%@page import="com.rays.ors.model.RoleModel"%>
...
<%@page import="com.rays.ors.controller.RoleListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.ors.bean.RoleBean"
	...
	<div align="center">
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label>Role :</label> <%-- <input type="text" name="name" placeholder="Enter Role " value="<%=ServletUtility.getParameter("name", request)%>"> --%>

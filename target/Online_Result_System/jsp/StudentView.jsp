...
<%@page import="com.rays.ors.controller.StudentCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.ors.bean.StudentBean"
		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("collegename", String.valueOf(bean.getCollegeId()), clist)%></td>
				...
				<tr>
					...
					<td><input type="text" name="dob" id="udate4"
						readonly="readonly" placeholder=" Date of Birth" size="20"

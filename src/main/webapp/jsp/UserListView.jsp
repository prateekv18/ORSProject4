...
<%@page import="com.rays.ors.model.UserModel"%>
...
<%@page import="com.rays.ors.controller.UserListCtl"%>
			...
			<table width="80%" align="center">
				<tr>
					...
					<td align="center"><label>FirstName</font> :
						...
						<label>LoginId</font> :
					</label> <%-- <input type="text" name="login" placeholder="Enter Login-Id" value="<%=ServletUtility.getParameter("login", request)%>">

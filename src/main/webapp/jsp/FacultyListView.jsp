<%@page import="com.rays.ors.model.FacultyModel"%>
<%@page import="com.rays.ors.bean.FacultyBean"%>
<%@page import="com.rays.ors.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.ors.controller.FacultyListCtl"%>
...
<body>
	...
	<jsp:useBean id="colbean" class="com.rays.ors.bean.CollegeBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="corbean" class="com.rays.ors.bean.CourseBean"
		scope="request"></jsp:useBean>

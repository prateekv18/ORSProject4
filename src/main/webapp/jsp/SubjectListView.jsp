<%@page import="com.rays.ors.model.CourseModel"%>
<%@page import="java.beans.beancontext.BeanContext"%>
<%@page import="com.rays.ors.util.HTMLUtility"%>
<%@page import="com.rays.ors.bean.CourseBean"%>
<%@page import="com.rays.ors.controller.SubjectListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.ors.bean.SubjectBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="cobean" class="com.rays.ors.bean.CourseBean"
		scope="request"></jsp:useBean>

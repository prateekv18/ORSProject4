<%@page import="com.rays.ors.controller.TimeTableCtl"%>
<%@page import="java.util.LinkedHashMap"%>
<%@page import="com.rays.ors.util.HTMLUtility"%>
<%@page import="com.rays.ors.bean.TimeTableBean"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.ors.controller.TimeTableListCtl"%>
...
<body>
<jsp:useBean id="bean" class="com.rays.ors.bean.TimeTableBean" scope="request"></jsp:useBean>
...
<table>
 ...
 <tr><th style="padding: 3px"></th></tr>  
	...
	<td> <input type="text" readonly="readonly" id="udate5" size="20" placeholder="Select Date" name="ExDate" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">

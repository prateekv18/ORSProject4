...
<%@page import="com.rays.ors.controller.UserRegistrationCtl"%><%@ page
...
<link rel="icon" type="image/png"
	href="<%=ORSView.APP_CONTEXT%>/img/ctm_logo.png" sizes="16*16" />
...
<body>
	...
	<form action="<%=ORSView.USER_REGISTRATION_CTL%>" method="post">
		...
		<div align="center">
			...
			<h3>
				<font color="green"> <%=ServletUtility.getErrorMessage(request)%>
				</font>
			</h3>
			<h3>
   ...
   <% System.out.println("=============)))))"+bean.getFirstName());%>  --%>
					<td style="position: fixed"><font color="red"><%=ServletUtility.getErrorMessage("firstName", request)%></td>
				</tr>

...
public class ChangePasswordCtl extends BaseCtl {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.rays.ors.controller.BaseCtl#validate(javax.servlet.http.
	 * HttpServletRequest)
	 */
	@Override
	protected boolean validate(HttpServletRequest request) {
		 ...
		 * request.setAttribute(
		 * "newPassword","Password should contain 8 letter with alpha-numeric,capital latter and special Character"
		 * ); pass = false; }
		 */
		...
		/*
		 * else if(!request.getParameter("newPassword").equals(request.getParameter(
		 * "confirmPassword"))){ request.setAttribute("confirmPassword",
		 * "New password and Confirm password must be same!!"); pass = false; }
		 */

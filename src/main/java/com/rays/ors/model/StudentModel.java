...
public class StudentModel {
	 ...
	 * @return bean: Object of student bean class
	 * 
	 ...
	 * @return bean: Object of student bean class
	 * @return ApplicationException the application exception
	 * @throws DatabaseException the database exception
	 */

	public StudentBean findByPK(long pk) throws ApplicationException, DatabaseException {
	 ...
	 * Update a Student
	 * 
	 * @param bean: Object of student bean class
	 * @throws ApplicationException     the application exception
	 * @throws DuplicateRecordException the application exception
	 * @throws DatabaseException        the database exception
	 */
	...
	public void update(StudentBean bean) throws ApplicationException, DuplicateRecordException, DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_STUDENT SET COLLEGEID=?,COLLEGENAME=?,FIRSTNAME=?,LASTNAME=?,DATEOFBIRTH=?,MOBILENO=?,EMAIL=?,CREATEDBY=?,MODIFIEDBY=?,CREATEDDATETIME=?,MODIFIEDDATETIME=? WHERE ID=?");
	...
	public List search(StudentBean bean) throws ApplicationException, DatabaseException {
	...
	public List search(StudentBean bean, int pageNo, int pageSize) throws ApplicationException, DatabaseException {

...
/**
 * The Class TimeTableModel. * @author Session Facade
 * 
...
public class TimeTableModel {
	...
	public long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException, DatabaseException {
		...
		log.debug("Timetable model method add started");
		...
		log.debug("timetable model method add Ended");
		return pk;
	}
	...
	public void update(TimeTableBean bean) throws ApplicationException, DuplicateRecordException, DatabaseException {
...
//				System.out.println("sql statement ==="+d);
	...
	public TimeTableBean checkBycss(long CourseId, long SubjectId, String semester) throws ApplicationException {
		...
		try {
			Connection con = JDBCDataSrc.getConnection();

...
import com.rays.ors.bean.DropdownListBean;
//import com.rays.ors.model.BaseModel;
...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
		...
		StringBuffer sb = new StringBuffer(
				"<select style='width: 178px;  height: 23px;' class='form-control' name='" + name + "'>");
		...
		if (select) {
			...
			sb.append(
					"<option style='width: 100px;  height: 30px;' selected value=''>--------------Select--------------------</option>");
		}

...
import com.rays.ors.controller.BaseCtl;
import com.rays.ors.controller.ORSView;
...
public class ServletUtility {
	...
	/*    *//**
			 ...
			 *//*
				 ...
				 * 
				 * request.setAttribute("bodyPage", page); RequestDispatcher rd = request
				 * .getRequestDispatcher(ORSView.LAYOUT_VIEW); rd.forward(request, response); }
				 */
	 ...
	 *//*
		 ...
		 * { String val = (String) request.getAttribute(property); if (val == null) {
		 * return ""; } else { return val; } }
		 */

	/**
	 * Sets error message to request
	 * 
	 * @param msg:     the string value
	 * @param request: the request
	 */
